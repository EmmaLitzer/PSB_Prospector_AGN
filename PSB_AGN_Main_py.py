...
# 13:   ### Define agelimits, tilde_alpha, and z_fraction_init for build_model ### --------------------------
...
# 15:   ### Build sps object using FracSFH basis ### -------------------------------------------------------
...
a = 1.0 + run_params['object_redshift'] # cosmological redshifting
wphot = obs["phot_wave"]                # photometric effective wavelengths

# spectroscopic wavelengths: *restframe* spectral wavelengths, since obs["wavelength"] is None
...
# 19:   ### Plot prediction SED with initial SED ### -------------------------------------------------------
...
# 20:   ### Rebuild model and obs for MCMC ### ---------------------------------------------------------------
...
# 22:   ### Create file path and re-run build functions ### ------------------------------------------------
